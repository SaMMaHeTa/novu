...
Cypress.Commands.add('waitLoadEnv', (beforeWait: () => void): void => {
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/environments').as('environments');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/environments/me').as('environments-me');
...
Cypress.Commands.add('waitLoadTemplatePage', (beforeWait: () => void): void => {
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/environments').as('environments');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/environments/me').as('environments-me');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/notification-groups').as('notification-groups');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/changes/count').as('changes-count');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/integrations/active').as('active-integrations');
  cy.intercept('GET', 'http://192.168.10.152:1336/v1/users/me').as('me');
