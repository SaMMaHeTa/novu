...
Now visit [http://94.250.201.139:4200](http://94.250.201.139:4200) to start using Novu.
...
- `REDIS_TLS={"servername":"94.250.201.139"}`
- `REDIS_CACHE_SERVICE_TLS={"servername":"94.250.201.139"}`
