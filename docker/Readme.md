...
Now visit [http://192.168.10.152:4200](http://192.168.10.152:4200) to start using Novu.
...
- `REDIS_TLS={"servername":"192.168.10.152"}`
- `REDIS_CACHE_SERVICE_TLS={"servername":"192.168.10.152"}`
