...
async function setupRunner() {
    ...
    inquirer.prompt(questions).then(async (answers) => {
        ...
        Web: http://192.168.10.5:4200
        Widget: http://192.168.10.5:4500
        API: http://192.168.10.5:3000
        Worker: http://192.168.10.5:3004
      `);
